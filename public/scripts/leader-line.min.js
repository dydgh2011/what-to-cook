...
var LeaderLine = (function () {
  ...
  var Z,
    ...
    L = 3,
    A = 4,
    V = { top: b, right: k, bottom: L, left: A },
    P = 1,
    N = 2,
    T = 3,
    W = 4,
    B = 5,
    R = { straight: P, arc: N, fluid: T, magnet: W, grid: B },
    Y = 'behind',
    f = C + '-defs',
    y =
    ...
    G = [b, k, L, A],
    D = 'auto',
    Q = { x: 'left', y: 'top', width: 'width', height: 'height' },
    z = 80,
    j = 4,
    H = 5,
    U = 120,
      ...
      function (e) {
        return (
          ...
          (!(e = Object.getPrototypeOf(e)) ||
            ((e = e.hasOwnProperty('constructor') && e.constructor) &&
              'function' == typeof e &&
              c.call(e) === d))
        );
      }),
      ...
      (e.SVGPathElement.prototype.getPathData &&
        ...
        (function () {
                    ...
                    : 'S' === e || 'Q' === e
                      ...
                      : 'C' === e
                        ...
                        : 'A' === e
                          ...
                          : 'Z' === e && (this._skipOptionalSpaces(), (n = [])),
                ...
                'M' === e.type
                  ...
                  : 'C' === e.type
                    ? ((o = e.values[0]),
                      ...
                      (r = e.values[4]),
                      (s = e.values[5]),
                      u.push({ type: 'C', values: [o, l, t, n, r, s] }),
                      (p = t),
                      (c = n),
                      (d = r),
                      (f = s))
                    : 'L' === e.type
                      ? ((r = e.values[0]),
                        (s = e.values[1]),
                        u.push({ type: 'L', values: [r, s] }),
                        (d = r),
                        (f = s))
                      : 'H' === e.type
                        ? ((r = e.values[0]),
                          u.push({ type: 'L', values: [r, f] }),
                          (d = r))
                        : 'V' === e.type
                          ? ((s = e.values[0]),
                            u.push({ type: 'L', values: [d, s] }),
                            (f = s))
                          : 'S' === e.type
                            ? ((t = e.values[0]),
                              (n = e.values[1]),
                              ...
                              (i =
                                'C' === h || 'S' === h
                                  ? ((a = d + (d - p)), f + (f - c))
                                  : ((a = d), f)),
                              u.push({ type: 'C', values: [a, i, t, n, r, s] }),
                              (p = t),
                              (c = n),
                              (d = r),
                              (f = s))
                                  ...
                                  ? ((n = e.values[0]),
                                    ...
                                    0 === n || 0 === a
                                      ? (u.push({
                                        ...
                                        (f = s))
                                      : (d === r && f === s) ||
                                        b(d, f, r, s, n, a, i, o, l).forEach(
                                          function (e) {
                                            u.push({ type: 'C', values: e }),
                                              (d = r),
                                              (f = s);
                                          },
                                        ))
          ...
          var s = e.SVGPathElement.prototype.setAttribute,
            ...
            b = function (e, t, n, a, i, o, l, r, s, u) {
              function h(e, t, n) {
                return {
              ...
              var p = (Math.PI * l) / 180,
                c = [];
              u
                ? ((_ = u[0]), (v = u[1]), (S = u[2]), (g = u[3]))
                : ((e = (m = h(e, t, -p)).x),
                  (t = m.y),
                  1 <
                    (m =
                      ((y = (e - (n = (f = h(n, a, -p)).x)) / 2) * y) /
                        (i * i) +
                      ((d = (t - (a = f.y)) / 2) * d) / (o * o)) &&
                    ((i *= m = Math.sqrt(m)), (o *= m)),
                  (f = i * i),
                  ...
                  (S =
                    ...
                    (e + n) / 2),
                  (g = (f * -o * y) / i + (t + a) / 2),
                  (_ = Math.asin(parseFloat(((t - g) / o).toFixed(9)))),
                  (v = Math.asin(parseFloat(((a - g) / o).toFixed(9)))),
                  e < S && (_ = Math.PI - _),
                  n < S && (v = Math.PI - v),
                  _ < 0 && (_ = 2 * Math.PI + _),
                  v < 0 && (v = 2 * Math.PI + v),
              ...
              var m = v - _,
                ...
                _ = [n + i * v, a - o * _],
                a = [n, a];
              if (((S[0] = 2 * m[0] - S[0]), (S[1] = 2 * m[1] - S[1]), u))
                return [S, _, a].concat(c);
              ...
              return (
                c.forEach(function (e, t) {
                  t % 2
                    ? x.push(h(c[t - 1], c[t], p).y)
                    : x.push(h(c[t], c[t + 1], p).x),
                    6 === x.length && (E.push(x), (x = []));
                }),
                E
              );
            };
          (e.SVGPathElement.prototype.setAttribute = function (e, t) {
            ...
            (e.SVGPathElement.prototype.getPathData = function (e) {
              if (e && e.normalize) {
                ...
                this[d]
                  ? (t = l(this[d]))
                  : ((t = n(this.getAttribute('d') || '')), (this[d] = l(t)));
                e = r(
                  ((s = []),
                  (c = p = h = u = null),
            ...
            (e.SVGPathElement.prototype.setPathData = function (e) {
              if (0 === e.length)
                o ? this.setAttribute('d', '') : this.removeAttribute('d');
              else {
            ...
            (e.SVGRectElement.prototype.getPathData = function (e) {
              var t = this.x.baseVal.value,
                ...
                n = (n = [
                  { type: 'M', values: [t + (o = a / 2 < o ? a / 2 : o), n] },
                  { type: 'H', values: [t + a - o] },
                  {
                    type: 'A',
                    values: [
    ...
    de = {
      ...
      plug_plugSE: { hasSE: !0, iniValue: Y },
      ...
      plugOutline_plugSE: { hasSE: !0, iniValue: Y },
      ...
      capsMaskMarker_plugSE: { hasSE: !0, iniValue: Y },
      ...
      E.forEach(function (e) {
        ...
        if (e.framesStart) {
          if (
            ...
            return (
              (a =
                e.frames[(e.lastFrame = e.reverse ? 0 : e.frames.length - 1)]),
          ...
          e.reverse && (t = e.duration - t),
            (a = e.frames[(e.lastFrame = Math.round(t / v))]),
  ...
  function ke(t, n) {
    ...
    return (
      typeof t != typeof n ||
      (e = he(t) ? 'obj' : Array.isArray(t) ? 'array' : '') !=
        (he(n) ? 'obj' : Array.isArray(n) ? 'array' : '') ||
      ('obj' === e
        ? ke((a = Object.keys(t).sort()), Object.keys(n).sort()) ||
          a.some(function (e) {
            return ke(t[e], n[e]);
          })
        : 'array' === e
  ...
  function Ie(e, t) {
    ...
    if (!t) {
      ...
      (o.left += i.pageXOffset),
        (o.right += i.pageXOffset),
        (o.top += i.pageYOffset),
        (o.bottom += i.pageYOffset);
    }
    return o;
  }
  function Ce(e, t) {
  ...
  function Pe(e, t, n) {
    ...
    return { x: t.x + Math.cos(e) * n, y: t.y + Math.sin(e) * n * -1 };
  }
  ...
  function Te(n, a, i, o, e) {
    ...
    return (
      [
        ...
        (r = l((s = p * e + p), n.x, a.x, i.x, o.x)),
          (s = l(s, n.y, a.y, i.y, o.y)),
          (s = r * r + s * s),
          (h += u[t] * Math.sqrt(s));
      }),
      p * h
  ...
  function We(e, t, n, a, i) {
    for (
      var o, l = 0.5, r = 1 - l;
      (o = Te(e, t, n, a, r)), !(Math.abs(o - i) <= 0.01);
  ...
  function Ue(e, t, n, a, i, o, l) {
    ...
    'auto-start-reverse' === n
      ...
      (t = t.viewBox.baseVal),
      r
        ? ((t.x = -a.right), (t.y = -a.bottom))
        : ((t.x = a.left), (t.y = a.top)),
      (t.width = a.width),
      (t.height = a.height),
      ie && je(e, l);
  }
  ...
  function qe(e) {
    ...
    return (
      'static' !== e.position
        ...
        : 'static' !== a.position &&
          ((n.x -= [a.marginLeft, a.borderLeftWidth].reduce(t, 0)),
          (n.y -= [a.marginTop, a.borderTopWidth].reduce(t, 0))),
      n
    );
  }
  function Qe(e) {
  ...
  function Ke(l) {
    ...
    if (
      ((f.position_path = p.path),
      (f.position_lineStrokeWidth = f.line_strokeWidth),
      (f.position_socketGravitySE = g = we(p.socketGravitySE)),
      (c = [0, 1].map(function (e) {
        var t = p.anchorSE[e],
          n = l.optionIsAttach.anchorSE[e],
          a = !1 !== n ? _e[t._id] : null,
          i =
            !1 !== n && a.conf.getStrokeWidth ? a.conf.getStrokeWidth(a, l) : 0,
          o =
            !1 !== n && a.conf.getBBoxNest
              ? a.conf.getBBoxNest(a, l, i)
              : Le(t, l.baseWindow);
        return (
          (f.capsMaskAnchor_pathDataSE[e] =
            !1 !== n && a.conf.getPathData
              ? a.conf.getPathData(a, l, i)
              : ((n = null != (t = o).right ? t.right : t.left + t.width),
          ...
          (f.capsMaskAnchor_strokeWidthSE[e] = i),
          o
        );
      })),
      (i = -1),
      p.socketSE[0] && p.socketSE[1]
        ? ((v[0] = S(c[0], p.socketSE[0])), (v[1] = S(c[1], p.socketSE[1])))
        : (p.socketSE[0] || p.socketSE[1]
            ? ((a = p.socketSE[0] ? ((n = 0), 1) : ((n = 1), 0)),
              (v[n] = S(c[n], p.socketSE[n])),
              (e = G.map(function (e) {
                return S(c[a], e);
              })).forEach(function (e) {
                var t = Ae(e, v[n]);
          ...
          [0, 1].forEach(function (e) {
            var t, n;
            p.socketSE[e] ||
              (c[e].width || c[e].height
                ? c[e].width || (v[e].socketId !== A && v[e].socketId !== k)
                  ? c[e].height ||
                    (v[e].socketId !== b && v[e].socketId !== L) ||
                    (v[e].socketId = 0 <= v[e ? 0 : 1].y - c[e].top ? L : b)
                  : (v[e].socketId = 0 <= v[e ? 0 : 1].x - c[e].left ? k : A)
                : ((t = v[e ? 0 : 1].x - c[e].left),
                  (n = v[e ? 0 : 1].y - c[e].top),
                  (v[e].socketId =
      ...
      f.position_path !== y.position_path ||
        f.position_lineStrokeWidth !== y.position_lineStrokeWidth ||
        [0, 1].some(function (e) {
          return (
            f.position_plugOverheadSE[e] !== y.position_plugOverheadSE[e] ||
            ((t = v[e]),
            (n = y.position_socketXYSE[e]),
            t.x !== n.x || t.y !== n.y || t.socketId !== n.socketId) ||
            ((t = g[e]),
            (n = y.position_socketGravitySE[e]),
            (e = null == t ? 'auto' : Array.isArray(t) ? 'array' : 'number') !=
              (null == n ? 'auto' : Array.isArray(n) ? 'array' : 'number') ||
              ('array' == e ? t[0] !== n[0] || t[1] !== n[1] : t !== n))
          );
          var t, n;
        }))
    ) {
      switch (
        ((l.pathList.baseVal = _ = []),
        (l.pathList.animVal = null),
        f.position_path)
      ) {
        case P:
          _.push([E(v[0]), E(v[1])]);
        ...
        case N:
          (t =
            ('number' == typeof g[0] && 0 < g[0]) ||
            ('number' == typeof g[1] && 0 < g[1])),
            (u = ne * (t ? -1 : 1)),
              ...
              var n,
                ...
                i = Array.isArray(a)
                  ...
                  : 'number' == typeof a
                    ...
                    : ((n = v[t ? 0 : 1]),
                      (a =
                        0 < (a = f.position_plugOverheadSE[t])
                          ? U + (K < a ? (a - K) * J : 0)
                          : z +
                            (f.position_lineStrokeWidth > j
                              ? (f.position_lineStrokeWidth - j) * H
                              : 0)),
                      e.socketId === b
                        ? { x: 0, y: -(i = (i = (e.y - n.y) / 2) < a ? a : i) }
                        : e.socketId === k
                          ? { x: (i = (i = (n.x - e.x) / 2) < a ? a : i), y: 0 }
                          : e.socketId === L
                            ? {
                                x: 0,
                ...
                if (o[0] === o[1]) {
                  if (n[0] && n[1])
                    return void (
                      f(u[1], u[0]) ||
                      (u[0][o[0]] === u[1][o[1]]
                        ? (s[0].push(u[0]), s[1].push(u[1]))
                        : ((e = u[0][o[0]] + (u[1][o[1]] - u[0][o[0]]) / 2),
                          s[0].push(c(u[0], Math.abs(e - u[0][o[0]]))),
                          s[1].push(c(u[1], Math.abs(e - u[1][o[1]])))))
                    );
                  n[0] !== n[1]
                    ? ((t = y(n)),
                      (a = m(u[t.notContain], u[t.contain], o[t.notContain])) <
                        ee && (u[t.notContain] = c(u[t.notContain], ee - a)),
                      s[t.notContain].push(u[t.notContain]),
                      (u[t.notContain] = c(
                        u[t.notContain],
                        ee,
                  ...
                  n[0] !== n[1]
                    ? ((t = y(n)),
                      ...
                      (u[t.notContain] = c(
                        u[t.notContain],
                        ee,
                        m(u[t.notContain], u[t.contain], o[t.contain]) >= ee
                          ? S(u[t.notContain], u[t.contain], o[t.contain])
                          : u[t.contain].dirId,
                      )))
                    : ((i = [
                        { x: u[0].x, y: u[0].y },
      ...
      (d = []),
        f.position_plugOverheadSE.forEach(function (e, t) {
          var n,
            ...
            p = !t;
          0 < e
            ? 2 === (n = _[(a = p ? 0 : _.length - 1)]).length
              ? ((d[a] = d[a] || Ae.apply(null, n)),
                d[a] > $ &&
                  (d[a] - e < $ && (e = d[a] - $),
                  (s = Ve(n[0], n[1], (p ? e : d[a] - e) / d[a])),
                  (_[a] = p ? [s, n[1]] : [n[0], s]),
                  (d[a] -= e)))
              : ((d[a] = d[a] || Te.apply(null, n)),
                d[a] > $ &&
                  (d[a] - e < $ && (e = d[a] - $),
                  (s = Ne(
                    n[0],
                    ...
                    n[2],
                    n[3],
                    We(n[0], n[1], n[2], n[3], p ? e : d[a] - e),
                  )),
                  (o = p ? ((i = n[0]), s.toP1) : ((i = n[3]), s.fromP2)),
                  (l = Math.atan2(i.y - s.y, s.x - i.x)),
                  (r = Ae(s, o)),
                  (s.x = i.x + Math.cos(l) * e),
                  (s.y = i.y + Math.sin(l) * e * -1),
                  (o.x = s.x + Math.cos(l) * r),
                  (o.y = s.y + Math.sin(l) * r * -1),
                  (_[a] = p
                    ? [s, s.toP1, s.toP2, n[3]]
                    : [n[0], s.fromP1, s.fromP2, s]),
                  (d[a] = null)))
            : e < 0 &&
              ((n = _[(a = p ? 0 : _.length - 1)]),
              (s = v[t].socketId),
              (t =
                -c[t][
                  'x' == (u = s === A || s === k ? 'x' : 'y')
              ...
              (h = (e = e < t ? t : e) * (s === A || s === b ? -1 : 1)),
              2 === n.length
                ? (n[p ? 0 : n.length - 1][u] += h)
                : (p ? [0, 1] : [n.length - 2, n.length - 1]).forEach(
                    function (e) {
                      n[e][u] += h;
                    },
                  ),
        ...
        (y.position_socketXYSE = we(v)),
        (y.position_plugOverheadSE = we(f.position_plugOverheadSE)),
        (y.position_path = f.position_path),
        (y.position_lineStrokeWidth = f.position_lineStrokeWidth),
        (y.position_socketGravitySE = we(g)),
        (m = !0),
  ...
  function $e(e, t) {
    ...
    t.line &&
      (U.line =
        ...
        (o = n.events),
        (l = !1),
        (l = Xe(n, a, 'line_color', i.lineColor, o.cur_line_color) || l),
        (l = Xe(n, a, 'line_colorTra', Oe(a.line_color)[0] < 1) || l),
        (l =
          Xe(n, a, 'line_strokeWidth', i.lineSize, o.cur_line_strokeWidth) ||
          l))),
      (t.plug || U.line) &&
        (U.plug =
          ((p = (h = e).options),
          ...
          [0, 1].forEach(function (e) {
            ...
            (f = Xe(h, c.plug_enabledSE, e, u !== Y) || f),
              ...
              u !== Y &&
                ((i = n = (t = X[q[u]]).widthR * p.plugSizeSE[e]),
                (o = a = t.heightR * p.plugSizeSE[e]),
                re && ((i *= c.line_strokeWidth), (o *= c.line_strokeWidth)),
                (f = Xe(h, c.plug_markerWidthSE, e, i) || f),
                (f = Xe(h, c.plug_markerHeightSE, e, o) || f),
                (c.capsMaskMarker_markerWidthSE[e] = n),
                (c.capsMaskMarker_markerHeightSE[e] = a)),
              (c.plugOutline_plugSE[e] = c.capsMaskMarker_plugSE[e] = u),
              c.plug_enabledSE[e]
                ? ((s = (c.line_strokeWidth / ue.lineSize) * p.plugSizeSE[e]),
      ...
      (t.lineOutline || U.line) &&
        (U.lineOutline =
          ...
          (l = i.curStats),
          (k = !1),
          (k = Xe(i, l, 'lineOutline_enabled', o.lineOutlineEnabled) || k),
          (k = Xe(i, l, 'lineOutline_color', o.lineOutlineColor) || k),
          (k =
            Xe(i, l, 'lineOutline_colorTra', Oe(l.lineOutline_color)[0] < 1) ||
            k),
          (o = l.line_strokeWidth * o.lineOutlineSize),
          (k =
            Xe(i, l, 'lineOutline_strokeWidth', l.line_strokeWidth - 2 * o) ||
            k),
          (k =
            Xe(
              i,
              l,
              'lineOutline_inStrokeWidth',
              l.lineOutline_colorTra
                ? l.lineOutline_strokeWidth + 2 * se
                : l.line_strokeWidth - o,
            ) || k))),
      (t.plugOutline || U.line || U.plug || U.lineOutline) &&
        (U.plugOutline =
          ((s = (r = e).options),
          (u = r.curStats),
          (y = !1),
          [0, 1].forEach(function (e) {
            ...
            (y =
              Xe(
                r,
                u.plugOutline_enabledSE,
                e,
                s.plugOutlineEnabledSE[e] &&
                  u.plug_enabled &&
                  u.plug_enabledSE[e] &&
                  !!n &&
                  !!n.outlineBase,
              ...
              (y =
                Xe(
                  r,
                  u.plugOutline_colorSE,
                  e,
                  (t = s.plugOutlineColorSE[e] || u.lineOutline_color),
                ) || y),
              (y = Xe(r, u.plugOutline_colorTraSE, e, Oe(t)[0] < 1) || y),
              n &&
                n.outlineBase &&
                ((t = s.plugOutlineSizeSE[e]) > n.outlineMax &&
                  (t = n.outlineMax),
                (t *= 2 * n.outlineBase),
                ...
                (y =
                  Xe(
                    r,
                    u.plugOutline_inStrokeWidthSE,
                    e,
                    u.plugOutline_colorTraSE[e]
                      ? t -
                          (se /
                            (u.line_strokeWidth / ue.lineSize) /
                            s.plugSizeSE[e]) *
                            2
                      : t / 2,
                  ) || y));
      ...
      (t.faces || U.line || U.plug || U.lineOutline || U.plugOutline) &&
        (U.faces =
          ...
          (E = !1),
          !g.line_altColor &&
            Xe(m, _, 'line_color', (S = g.line_color), v.apl_line_color) &&
            ((m.lineFace.style.stroke = S), (E = !0)),
          Xe(
            m,
            _,
            'line_strokeWidth',
            (S = g.line_strokeWidth),
            v.apl_line_strokeWidth,
          ) &&
            ((m.lineShape.style.strokeWidth = S + 'px'),
            (E = !0),
            (oe || ie) &&
              (je(m, m.lineShape),
              ie && (je(m, m.lineFace), je(m, m.lineMaskCaps)))),
          Xe(
            m,
            _,
            'lineOutline_enabled',
            (S = g.lineOutline_enabled),
            v.apl_lineOutline_enabled,
          ) &&
            ((m.lineOutlineFace.style.display = S ? 'inline' : 'none'),
            (E = !0)),
          g.lineOutline_enabled &&
            (Xe(
              m,
              _,
              'lineOutline_color',
              (S = g.lineOutline_color),
              v.apl_lineOutline_color,
            ) && ((m.lineOutlineFace.style.stroke = S), (E = !0)),
            Xe(
              m,
              _,
              'lineOutline_strokeWidth',
              (S = g.lineOutline_strokeWidth),
              v.apl_lineOutline_strokeWidth,
            ) &&
              ((m.lineOutlineMaskShape.style.strokeWidth = S + 'px'),
              (E = !0),
              ie && (je(m, m.lineOutlineMaskCaps), je(m, m.lineOutlineFace))),
            Xe(
              m,
              _,
              'lineOutline_inStrokeWidth',
              (S = g.lineOutline_inStrokeWidth),
              v.apl_lineOutline_inStrokeWidth,
            ) &&
              ((m.lineMaskShape.style.strokeWidth = S + 'px'),
              (E = !0),
              ie && (je(m, m.lineOutlineMaskCaps), je(m, m.lineOutlineFace)))),
          Xe(m, _, 'plug_enabled', (S = g.plug_enabled), v.apl_plug_enabled) &&
            ((m.plugsFace.style.display = S ? 'inline' : 'none'), (E = !0)),
          g.plug_enabled &&
            [0, 1].forEach(function (n) {
              ...
              Xe(
                ...
                _.plug_enabledSE,
                n,
                (S = g.plug_enabledSE[n]),
                v.apl_plug_enabledSE,
              ) &&
                ((m.plugsFace.style[a.prop] = S
                  ? 'url(#' + m.plugMarkerIdSE[n] + ')'
                  : 'none'),
                (E = !0)),
                g.plug_enabledSE[n] &&
                  (Xe(m, _.plug_plugSE, n, e, v.apl_plug_plugSE) &&
                    ((m.plugFaceSE[n].href.baseVal = '#' + t.elmId),
                    Ue(
                      m,
                      m.plugMarkerSE[n],
                      a.orient,
                  ...
                  Xe(
                    ...
                    ((m.plugFaceSE[n].style.fill = S),
                    (E = !0),
                    (le || re || ie) &&
                      !g.line_colorTra &&
                      je(m, ie ? m.lineMaskCaps : m.capsMaskLine)),
                  ['markerWidth', 'markerHeight'].forEach(function (e) {
                    var t = 'plug_' + e + 'SE';
                    Xe(m, _[t], n, (S = g[t][n]), v['apl_' + t]) &&
                      ((m.plugMarkerSE[n][e].baseVal.value = S), (E = !0));
                  }),
                  Xe(
                    m,
                    _.plugOutline_enabledSE,
                    n,
                    (S = g.plugOutline_enabledSE[n]),
                    v.apl_plugOutline_enabledSE,
                  ) &&
                    (S
                      ? ((m.plugFaceSE[n].style.mask =
                          'url(#' + m.plugMaskIdSE[n] + ')'),
                        (m.plugOutlineFaceSE[n].style.display = 'inline'))
                      : ((m.plugFaceSE[n].style.mask = 'none'),
                        (m.plugOutlineFaceSE[n].style.display = 'none')),
                    (E = !0)),
                  g.plugOutline_enabledSE[n] &&
                    (Xe(
                      m,
                      _.plugOutline_plugSE,
                      n,
                      e,
                      v.apl_plugOutline_plugSE,
                    ) &&
                      ((m.plugOutlineFaceSE[n].href.baseVal =
                        m.plugMaskShapeSE[n].href.baseVal =
                        m.plugOutlineMaskShapeSE[n].href.baseVal =
                          '#' + t.elmId),
                      [m.plugMaskSE[n], m.plugOutlineMaskSE[n]].forEach(
                        function (e) {
                    ...
                    Xe(
                      ...
                      n,
                      (S = g.plugOutline_colorSE[n]),
                      v.apl_plugOutline_colorSE,
                    ) &&
                      ((m.plugOutlineFaceSE[n].style.fill = S),
                      (E = !0),
                      ie &&
                        (je(m, m.lineMaskCaps), je(m, m.lineOutlineMaskCaps))),
                    Xe(
                      m,
                      _.plugOutline_strokeWidthSE,
                      n,
                      (S = g.plugOutline_strokeWidthSE[n]),
                      v.apl_plugOutline_strokeWidthSE,
                    ) &&
                      ((m.plugOutlineMaskShapeSE[n].style.strokeWidth =
                        S + 'px'),
                      (E = !0)),
                    Xe(
                      m,
                      ...
                      n,
                      (S = g.plugOutline_inStrokeWidthSE[n]),
                      v.apl_plugOutline_inStrokeWidthSE,
                    ) &&
                      ((m.plugMaskShapeSE[n].style.strokeWidth = S + 'px'),
                      (E = !0))));
            }),
          E)),
      ...
      (t.path || U.position) &&
        (U.path =
          ((k = (x = e).curStats),
          (I = x.aplStats),
          (M = x.pathList.animVal || x.pathList.baseVal),
          (w = k.path_edge),
          (C = !1),
          M &&
            ((w.x1 = w.x2 = M[0][0].x),
            ...
            Fe(b, I.path_pathData) &&
              ...
              (C = !0),
              ie
                ? (je(x, x.plugsFace), je(x, x.lineMaskCaps))
                : oe && je(x, x.linePath),
              x.events.apl_path &&
                x.events.apl_path.forEach(function (e) {
                  e(x, b);
                }))),
          C)),
      (U.viewBox =
        ...
        (L = M.viewBox_bBox),
        (A = I.viewBox_bBox),
        (V = O.svg.viewBox.baseVal),
        (P = O.svg.style),
        (N = !1),
        (I = Math.max(
          M.line_strokeWidth / 2,
          M.viewBox_plugBCircleSE[0] || 0,
          M.viewBox_plugBCircleSE[1] || 0,
        )),
        (T = { x1: C.x1 - I, y1: C.y1 - I, x2: C.x2 + I, y2: C.y2 + I }),
        O.events.new_edge4viewBox &&
          O.events.new_edge4viewBox.forEach(function (e) {
            e(O, T);
          }),
        (L.x = M.lineMask_x = M.lineOutlineMask_x = M.maskBGRect_x = T.x1),
        (L.y = M.lineMask_y = M.lineOutlineMask_y = M.maskBGRect_y = T.y1),
        (L.width = T.x2 - T.x1),
        (L.height = T.y2 - T.y1),
      ...
      (U.mask =
        ...
        R.plug_enabled
          ? [0, 1].forEach(function (e) {
              R.capsMaskMarker_enabledSE[e] =
                (R.plug_enabledSE[e] && R.plug_colorTraSE[e]) ||
                (R.plugOutline_enabledSE[e] && R.plugOutline_colorTraSE[e]);
            })
          : (R.capsMaskMarker_enabledSE[0] = R.capsMaskMarker_enabledSE[1] =
              !1),
        (R.capsMaskMarker_enabled =
          R.capsMaskMarker_enabledSE[0] || R.capsMaskMarker_enabledSE[1]),
        (R.lineMask_outlineMode = R.lineOutline_enabled),
        (R.caps_enabled =
          R.capsMaskMarker_enabled ||
          R.capsMaskAnchor_enabledSE[0] ||
          R.capsMaskAnchor_enabledSE[1]),
        (R.lineMask_enabled = R.caps_enabled || R.lineMask_outlineMode),
        ((R.lineMask_enabled && !R.lineMask_outlineMode) ||
          R.lineOutline_enabled) &&
          ['x', 'y'].forEach(function (e) {
            var t = 'maskBGRect_' + e;
            Xe(W, F, t, (B = R[t])) &&
              ((W.maskBGRect[e].baseVal.value = B), (G = !0));
          }),
        Xe(W, F, 'lineMask_enabled', (B = R.lineMask_enabled)) &&
          ((W.lineFace.style.mask = B ? 'url(#' + W.lineMaskId + ')' : 'none'),
          (G = !0),
          re && je(W, W.lineMask)),
        R.lineMask_enabled &&
          (Xe(W, F, 'lineMask_outlineMode', (B = R.lineMask_outlineMode)) &&
            (B
              ? ((W.lineMaskBG.style.display = 'none'),
                (W.lineMaskShape.style.display = 'inline'))
              : ((W.lineMaskBG.style.display = 'inline'),
                (W.lineMaskShape.style.display = 'none')),
            (G = !0)),
          ['x', 'y'].forEach(function (e) {
            var t = 'lineMask_' + e;
            Xe(W, F, t, (B = R[t])) &&
              ((W.lineMask[e].baseVal.value = B), (G = !0));
          }),
          Xe(W, F, 'caps_enabled', (B = R.caps_enabled)) &&
            ((W.lineMaskCaps.style.display =
              W.lineOutlineMaskCaps.style.display =
                B ? 'inline' : 'none'),
            (G = !0),
            re && je(W, W.capsMaskLine)),
          R.caps_enabled &&
            ([0, 1].forEach(function (e) {
              var t;
              Xe(
                W,
                F.capsMaskAnchor_enabledSE,
                e,
                (B = R.capsMaskAnchor_enabledSE[e]),
              ) &&
                ((W.capsMaskAnchorSE[e].style.display = B ? 'inline' : 'none'),
                (G = !0),
                re && je(W, W.lineMask)),
                R.capsMaskAnchor_enabledSE[e] &&
                  (Fe(
                    (t = R.capsMaskAnchor_pathDataSE[e]),
                    F.capsMaskAnchor_pathDataSE[e],
                  ) &&
                    (W.capsMaskAnchorSE[e].setPathData(t),
                    (F.capsMaskAnchor_pathDataSE[e] = t),
                    (G = !0)),
                  Xe(
                    W,
                    F.capsMaskAnchor_strokeWidthSE,
                    e,
                    (B = R.capsMaskAnchor_strokeWidthSE[e]),
                  ) &&
                    ((W.capsMaskAnchorSE[e].style.strokeWidth = B + 'px'),
                    (G = !0)));
            }),
            Xe(
              W,
              ...
              (B = R.capsMaskMarker_enabled),
            ) &&
              ((W.capsMaskLine.style.display = B ? 'inline' : 'none'),
              (G = !0)),
            R.capsMaskMarker_enabled &&
              [0, 1].forEach(function (n) {
                ...
                Xe(
                  W,
                  F.capsMaskMarker_enabledSE,
                  n,
                  (B = R.capsMaskMarker_enabledSE[n]),
                ) &&
                  ((W.capsMaskLine.style[a.prop] = B
                    ? 'url(#' + W.lineMaskMarkerIdSE[n] + ')'
                    : 'none'),
                  (G = !0)),
                  R.capsMaskMarker_enabledSE[n] &&
                    (Xe(W, F.capsMaskMarker_plugSE, n, e) &&
                      ((W.capsMaskMarkerShapeSE[n].href.baseVal =
                        '#' + t.elmId),
                      Ue(
                        W,
                        W.capsMaskMarkerSE[n],
                        a.orient,
                        t.bBox,
                        W.svg,
                        W.capsMaskMarkerShapeSE[n],
                        W.capsMaskLine,
                      ),
                      (G = !0),
                      oe && (je(W, W.capsMaskLine), je(W, W.lineFace))),
                    ['markerWidth', 'markerHeight'].forEach(function (e) {
                      var t = 'capsMaskMarker_' + e + 'SE';
                      Xe(W, F[t], n, (B = R[t][n])) &&
                        ((W.capsMaskMarkerSE[n][e].baseVal.value = B),
                        (G = !0));
                    }));
              }))),
        R.lineOutline_enabled &&
          ['x', 'y'].forEach(function (e) {
            ...
            Xe(W, F, t, (B = R[t])) &&
              ((W.lineOutlineMask[e].baseVal.value = B), (G = !0));
          }),
        G)),
      t.effect &&
        ((j = (D = e).curStats),
        ...
        Object.keys(Z).forEach(function (e) {
          var t = Z[e],
            ...
            e = j[a];
          Xe(D, H, n, (z = j[n]))
            ? (z && (H[a] = we(e)), t[z ? 'init' : 'remove'](D))
            : z &&
              ke(e, H[a]) &&
              (t.remove(D), (H[n] = !0), (H[a] = we(e)), t.init(D));
        })),
  ...
  function tt(e, t, n, a) {
    ...
    (i.show_on = t),
      n &&
        w[n] &&
        ((i.show_effect = n),
        (i.show_animOptions = et(he(a) ? a : {}, w[n].defaultAnimOptions))),
      (l.show_on = i.show_on !== o.show_on),
      (l.show_effect = i.show_effect !== o.show_effect),
      (l.show_animOptions = ke(i.show_animOptions, o.show_animOptions)),
      l.show_effect || l.show_animOptions
        ? i.show_inAnim
          ? ((n = l.show_effect
              ? w[o.show_effect].stop(e, !0, !0)
              : w[o.show_effect].stop(e)),
            r(),
            w[o.show_effect].init(e, n))
          : l.show_on &&
            (o.show_effect && l.show_effect && w[o.show_effect].stop(e, !0, !0),
            r(),
            w[o.show_effect].init(e))
  ...
  function nt(e, t, n) {
    ...
    return (
      ...
      (!t.conf.bind || t.conf.bind(t, n)) &&
      (e.attachments.push(t), t.boundTargets.push(n), 1)
    );
  }
  function at(n, a, e) {
  ...
  function it(s, u) {
    ...
    function v(e, t, n, a, i, o, l) {
      ...
      return (
        null != t[n] &&
          (s = (t[n] + '').toLowerCase()) &&
          ((l.acceptsAuto && s === D) || (u = a[s])) &&
          u !== l.container[l.key] &&
          ((l.container[l.key] = u), (r = !0)),
        null != l.container[l.key] ||
          l.acceptsAuto ||
          ((l.container[l.key] = l.default), (r = !0)),
        r
      );
    }
    function E(e, t, n, a, i, o, l, r, s) {
      ...
      return (
        null != t[n] &&
          ((l.acceptsAuto && (t[n] + '').toLowerCase() === D) ||
            ((p = h = t[n]),
            ('number' === (c = a) ? pe(p) : typeof p === c) &&
              ((h = s && 'string' === a && h ? h.trim() : h), 1) &&
              (!r || r(h)))) &&
          h !== l.container[l.key] &&
          ((l.container[l.key] = h), (u = !0)),
        null != l.container[l.key] ||
          l.acceptsAuto ||
          ((l.container[l.key] = l.default), (u = !0)),
        u
      );
    }
    if (
    ...
    function b(e) {
      ...
      return (
        (t.id = e),
        (t.markerUnits.baseVal = SVGMarkerElement.SVG_MARKERUNITS_STROKEWIDTH),
    ...
    i &&
      (c = (function (e, t) {
        ...
        !1 !== s.optionIsAttach.anchorSE[0]
          ? _e[S.anchorSE[0]._id].element
          : S.anchorSE[0],
        !1 !== s.optionIsAttach.anchorSE[1]
          ? _e[S.anchorSE[1]._id].element
          : S.anchorSE[1],
      )) !== s.baseWindow &&
      ((e = c),
      (f = (n = s).aplStats),
      ...
      n.baseWindow && n.svg && n.baseWindow.document.body.removeChild(n.svg),
      Qe((n.baseWindow = e)),
      (n.bodyOffset = qe(e)),
      (n.svg = t = y.createElementNS(ae, 'svg')),
      (t.className.baseVal = C),
      t.viewBox.baseVal || t.setAttribute('viewBox', '0 0 0 0'),
      (n.defs = a = t.appendChild(y.createElementNS(ae, 'defs'))),
      (n.linePath = l = a.appendChild(y.createElementNS(ae, 'path'))),
      (l.id = r = m + '-line-path'),
      (l.className.baseVal = C + '-line-path'),
      re && (l.style.fill = 'none'),
      (n.lineShape = l = a.appendChild(y.createElementNS(ae, 'use'))),
      (l.id = h = m + '-line-shape'),
      (l.href.baseVal = '#' + r),
      ...
      (n.lineMaskMarkerIdSE = [
        m + '-caps-mask-marker-0',
        m + '-caps-mask-marker-1',
      ]),
      ...
      (l.href.baseVal = '#' + h),
      (n.maskBGRect = l = k(a.appendChild(y.createElementNS(ae, 'rect')))),
      (l.id = c = m + '-mask-bg-rect'),
      (l.className.baseVal = C + '-mask-bg-rect'),
      re && (l.style.fill = 'white'),
      (n.lineMask = k(x((n.lineMaskId = m + '-line-mask')))),
      (n.lineMaskBG = l = n.lineMask.appendChild(y.createElementNS(ae, 'use'))),
      (l.href.baseVal = '#' + c),
      (n.lineMaskShape = l =
        n.lineMask.appendChild(y.createElementNS(ae, 'use'))),
      (l.className.baseVal = C + '-line-mask-shape'),
      (l.href.baseVal = '#' + r),
      (l.style.display = 'none'),
      (n.lineMaskCaps = l =
        n.lineMask.appendChild(y.createElementNS(ae, 'use'))),
      (l.href.baseVal = '#' + p),
      (n.lineOutlineMask = k(x((e = m + '-line-outline-mask')))),
      ((l = n.lineOutlineMask.appendChild(
        y.createElementNS(ae, 'use'),
      )).href.baseVal = '#' + c),
      (n.lineOutlineMaskShape = l =
        n.lineOutlineMask.appendChild(y.createElementNS(ae, 'use'))),
      (l.className.baseVal = C + '-line-outline-mask-shape'),
      (l.href.baseVal = '#' + r),
      (n.lineOutlineMaskCaps = l =
        n.lineOutlineMask.appendChild(y.createElementNS(ae, 'use'))),
      (l.href.baseVal = '#' + p),
      (n.face = t.appendChild(y.createElementNS(ae, 'g'))),
      (n.lineFace = l = n.face.appendChild(y.createElementNS(ae, 'use'))),
      (l.href.baseVal = '#' + h),
      (n.lineOutlineFace = l =
        n.face.appendChild(y.createElementNS(ae, 'use'))),
      (l.href.baseVal = '#' + h),
      (l.style.mask = 'url(#' + e + ')'),
      (l.style.display = 'none'),
      (n.plugMaskIdSE = [m + '-plug-mask-0', m + '-plug-mask-1']),
      (n.plugMaskSE = [0, 1].map(function (e) {
      ...
      (n.plugOutlineFaceSE = [0, 1].map(function (e) {
        var t = n.plugMarkerShapeSE[e].appendChild(
          y.createElementNS(ae, 'use'),
        );
        return (
          (t.style.mask = 'url(#' + d[e] + ')'), (t.style.display = 'none'), t
        );
      })),
      ...
      (l.href.baseVal = '#' + h),
      (l.style.display = 'none'),
      n.curStats.show_inAnim
        ? ((n.isShown = 1), w[f.show_effect].stop(n, !0))
        : n.isShown || (t.style.visibility = 'hidden'),
      ...
      (g.line =
        ...
        g.effect =
          !0)),
      (g.position = v(S, u, 'path', R, null, null, ue.path) || g.position),
      (g.position = v(S, u, 'startSocket', V, 'socketSE', 0) || g.position),
      (g.position = v(S, u, 'endSocket', V, 'socketSE', 1) || g.position),
        ...
        null != e &&
          (Array.isArray(e)
            ? pe(e[0]) &&
              pe(e[1]) &&
              ((i = [e[0], e[1]]),
              Array.isArray(S.socketGravitySE[t]) &&
                ((n = i),
                (a = S.socketGravitySE[t]),
                n.length === a.length &&
            ...
            : ((e + '').toLowerCase() === D
                ? (i = null)
                : pe(e) && 0 <= e && (i = e),
              i === S.socketGravitySE[t] && (i = !1)),
          !1 !== i && ((S.socketGravitySE[t] = i), (g.position = !0)));
      }),
      (g.line =
        E(S, u, 'color', null, 'lineColor', null, ue.lineColor, null, !0) ||
        g.line),
      (g.line =
        E(S, u, 'size', null, 'lineSize', null, ue.lineSize, function (e) {
          return 0 < e;
        }) || g.line),
      ['startPlug', 'endPlug'].forEach(function (e, t) {
        (g.plug = v(S, u, e, F, 'plugSE', t, ue.plugSE[t]) || g.plug),
          (g.plug =
            E(S, u, e + 'Color', 'string', 'plugColorSE', t, null, null, !0) ||
            g.plug),
          (g.plug =
            E(
              S,
      ...
      ['startLabel', 'endLabel', 'middleLabel'].forEach(function (e, t) {
        var n,
          ...
          o = u[e],
          l =
            S.labelSEM[t] && !s.optionIsAttach.labelSEM[t]
              ? _e[S.labelSEM[t]._id].text
              : S.labelSEM[t],
          r = !1;
        if (
          ...
          if (
            (S.labelSEM[t] &&
              (at(s, _e[S.labelSEM[t]._id]), (S.labelSEM[t] = '')),
            o)
          ) {
            if (
              (r
                ? (a = _e[(i = o)._id]).boundTargets
                    .slice()
                    .forEach(function (e) {
                      a.conf.removeOption(a, e);
                    })
                : (i = new M(O.captionLabel, [o])),
              !nt(s, _e[i._id], e))
            )
              throw new Error("Can't bind attachment");
            S.labelSEM[t] = i;
          ...
          return (
            o.optionsConf.forEach(function (e) {
              var t = e[0],
                n = e[3];
              null == e[4] || i[n] || (i[n] = []),
                ('function' == typeof t ? t : 'id' === t ? v : E).apply(
                  null,
        ...
        function r(e) {
          ...
          return (
            e.hasOwnProperty('animation')
              ? he(e.animation)
                ? (t = s.curStats[n] = et(e.animation, o.defaultAnimOptions))
                : ((t = !!e.animation),
                  (s.curStats[n] = t ? et({}, o.defaultAnimOptions) : null))
              : ((t = !!o.defaultEnabled),
                (s.curStats[n] = t ? et({}, o.defaultAnimOptions) : null)),
            t
          );
  ...
  function ot(e, t, n) {
    ...
    Ye(a.curStats, de),
      ...
      Ye(a.curStats, fe),
      Ye(a.aplStats, fe),
      (a.curStats.show_effect = ye),
      (a.curStats.show_animOptions = we(w[ye].defaultAnimOptions)),
      Object.defineProperty(this, '_id', { value: ++ge }),
      (a._id = this._id),
      (Se[this._id] = a),
  ...
  function rt(e, t) {
    ...
    e.argOptions.every(function (e) {
      ...
      e.stats && (Ye(a.curStats, e.stats), Ye(a.aplStats, e.stats)),
      Object.defineProperty(this, '_id', { value: ++ve }),
  ...
  return (
    (Z = {
      dash: {
        ...
        init: function (e) {
          Ge(e, 'apl_line_strokeWidth', Z.dash.update),
        ...
        update: function (t) {
          ...
          (n.dash_len = i.len || 2 * a.line_strokeWidth),
            ...
            (o = Xe(t, a, 'dash_gap', n.dash_gap) || o) &&
              (t.lineFace.style.strokeDasharray =
                a.dash_len + ',' + a.dash_gap),
            n.dash_animOptions
              ? ((o = Xe(t, a, 'dash_maxOffset', n.dash_maxOffset)),
                a.dash_animOptions &&
                  (o || ke(n.dash_animOptions, a.dash_animOptions)) &&
                  (n.dash_animId &&
                    ((e = g.stop(n.dash_animId)), g.remove(n.dash_animId)),
      ...
      gradient: {
        ...
        init: function (e) {
          ...
          (e.efc_gradient_gradient = t =
            t.appendChild(a.createElementNS(ae, 'linearGradient'))),
            (t.id = n),
            ...
            Ge(e, 'cur_plug_colorSE', Z.gradient.update),
        ...
        update: function (a) {
          ...
          [0, 1].forEach(function (e) {
            ...
            (e = n[0][0]),
            (i.gradient_pointSE[0] = { x: e.x, y: e.y }),
            (e = (n = n[n.length - 1])[n.length - 1]),
              ...
              Xe(a, o.gradient_colorSE, t, (n = i.gradient_colorSE[t])) &&
                ...
                ['x', 'y'].forEach(function (e) {
                  (n = i.gradient_pointSE[t][e]) !== o.gradient_pointSE[t][e] &&
                    (a.efc_gradient_gradient[e + (t + 1)].baseVal.value =
        ...
        init: function (t) {
          var e,
            ...
            s =
              ...
              (i = {}),
              'boolean' != typeof u &&
                (u = !!window.SVGFEDropShadowElement && !re),
              (i.elmsAppend = [
                (i.elmFilter = o = e.createElementNS(ae, 'filter')),
              ]),
              (o.filterUnits.baseVal =
                SVGUnitTypes.SVG_UNIT_TYPE_USERSPACEONUSE),
              o.x.baseVal.newValueSpecifiedUnits(
                SVGLength.SVG_LENGTHTYPE_PX,
                0,
              ),
              o.y.baseVal.newValueSpecifiedUnits(
                SVGLength.SVG_LENGTHTYPE_PX,
                0,
              ),
              o.width.baseVal.newValueSpecifiedUnits(
                SVGLength.SVG_LENGTHTYPE_PERCENTAGE,
                100,
              ),
              o.height.baseVal.newValueSpecifiedUnits(
                SVGLength.SVG_LENGTHTYPE_PERCENTAGE,
                100,
              ),
              (o.id = n),
              u
                ? ((i.elmOffset =
                    i.elmBlur =
                    a =
                      o.appendChild(e.createElementNS(ae, 'feDropShadow'))),
                  (i.styleFlood = a.style))
                : ((i.elmBlur = o.appendChild(
                    e.createElementNS(ae, 'feGaussianBlur'),
                  )),
                  (i.elmOffset = a =
                    o.appendChild(e.createElementNS(ae, 'feOffset'))),
                  (a.result.baseVal = 'offsetblur'),
                  (a = o.appendChild(e.createElementNS(ae, 'feFlood'))),
                  (i.styleFlood = a.style),
                  ((a = o.appendChild(
                    e.createElementNS(ae, 'feComposite'),
                  )).in2.baseVal = 'offsetblur'),
                  (a.operator.baseVal =
                    SVGFECompositeElement.SVG_FECOMPOSITE_OPERATOR_IN),
                  (a = o.appendChild(
                    e.createElementNS(ae, 'feMerge'),
                  )).appendChild(e.createElementNS(ae, 'feMergeNode')),
                  (a.appendChild(
                    e.createElementNS(ae, 'feMergeNode'),
    ...
    (w = {
      none: {
        ...
        init: function (e, t) {
          var n = e.curStats;
          n.show_animId && (g.remove(n.show_animId), (n.show_animId = null)),
            w.none.start(e, t);
        },
        start: function (e, t) {
          w.none.stop(e, !0);
      ...
      fade: {
        ...
        start: function (e, t) {
          ...
          a.show_inAnim && (n = g.stop(a.show_animId)),
            Je(e, 1),
            (a.show_inAnim = !0),
            g.start(a.show_animId, !e.aplStats.show_on, null != t ? t : n);
        },
        stop: function (e, t, n) {
          var a,
            i = e.curStats;
          return (
            ...
            (i.show_inAnim = !1),
            t && ((e.svg.style.opacity = n ? '' : '0'), Je(e, n)),
            a
          );
        },
      },
      draw: {
            ...
            (t.show_animId = g.add(
              function (e) {
                ...
                if (0 === e) n = [[o[0][0], o[0][0]]];
                  ...
                  t &&
                    (2 === (a = o[i]).length
                      ? n.push([a[0], Ve(a[0], a[1], t / l[i])])
                      : ((e = Ne(
                          a[0],
                          a[1],
                          a[2],
                          a[3],
                          We(a[0], a[1], a[2], a[3], t),
                        )),
                        n.push([a[0], e.fromP1, e.fromP2, e])));
                }
                return n;
              },
              function (e, t) {
                t
                  ? w.draw.stop(n, !0)
                  : ((n.pathList.animVal = e), $e(n, { path: !0 }));
              },
              a.show_animOptions.duration,
              1,
              a.show_animOptions.timing,
        ...
        start: function (e, t) {
          ...
          a.show_inAnim && (n = g.stop(a.show_animId)),
            Je(e, 1),
            (a.show_inAnim = !0),
            Ge(e, 'apl_position', w.draw.update),
            g.start(a.show_animId, !e.aplStats.show_on, null != t ? t : n);
        },
        stop: function (e, t, n) {
          var a,
        ...
        update: function (e) {
          De(e, 'apl_position', w.draw.update),
            e.curStats.show_inAnim
              ? w.draw.init(e, w.draw.stop(e))
    ...
    [
      ...
      Object.defineProperty(ot.prototype, t, {
        get: function () {
          var e =
            null != a
              ? Se[this._id].options[n][a]
              : n
                ? Se[this._id].options[n]
                : Se[this._id].options[t];
    ...
    [
      ['path', R],
      ['startSocket', V, 'socketSE', 0],
      ['endSocket', V, 'socketSE', 1],
      ['startPlug', F, 'plugSE', 0],
      ['endPlug', F, 'plugSE', 1],
    ].forEach(function (e) {
      var a = e[0],
        i = e[1],
      ...
      Object.defineProperty(ot.prototype, a, {
        get: function () {
          var t,
            n =
              null != l
                ? Se[this._id].options[o][l]
                : o
                  ? Se[this._id].options[o]
                  : Se[this._id].options[a];
          return n
        ...
        get: function () {
          ...
          return he(t)
            ? ((s = t),
              ...
              a.anim && (e.animation = we(s.animation)),
              e)
            : t;
        },
        set: lt(n),
    ...
    (M = rt),
    (window.LeaderLineAttachment = M),
    (I = function (e, t) {
      return (
        e instanceof M &&
        (!(e.isRemoved || (t && _e[e._id].conf.type !== t)) || null)
      );
    }),
    (O = {
      pointAnchor: {
        ...
        init: function (e, t) {
          return (
            (e.element = O.pointAnchor.checkElement(t.element)),
            (e.x = O.pointAnchor.parsePercent(t.x, !0) || [0.5, !0]),
            (e.y = O.pointAnchor.parsePercent(t.y, !0) || [0.5, !0]),
            !0
          );
        },
        removeOption: function (e, t) {
          ...
          i === e &&
            (i =
              e === document.body ? new M(O.pointAnchor, [i]) : document.body),
            (a[t.optionName] = i),
            it(n, a);
        },
        getBBoxNest: function (e, t) {
          ...
          return (
            ...
            (n.top = n.bottom = n.top + e.y[0] * (e.y[1] ? t : 1)),
            n
          );
        },
        ...
        checkElement: function (e) {
          ...
          else if (!Me(e)) throw new Error('`element` must be Element');
          return e;
        },
      },
      areaAnchor: {
        ...
        init: function (a, e) {
          var t,
            n = [];
          return (
            (a.element = O.pointAnchor.checkElement(e.element)),
            'string' == typeof e.color && (a.color = e.color.trim()),
            'string' == typeof e.fillColor && (a.fill = e.fillColor.trim()),
            pe(e.size) && 0 <= e.size && (a.size = e.size),
            e.dash &&
              ((a.dash = !0),
              pe(e.dash.len) && 0 < e.dash.len && (a.dashLen = e.dash.len),
              pe(e.dash.gap) && 0 < e.dash.gap && (a.dashGap = e.dash.gap)),
            'circle' === e.shape
              ? (a.shape = e.shape)
              : 'polygon' === e.shape &&
                  ...
                  e.points.every(function (e) {
                    ...
                    return (
                      !(
                        !(t.x = O.pointAnchor.parsePercent(e[0], !0)) ||
                        !(t.y = O.pointAnchor.parsePercent(e[1], !0))
                      ) &&
                      (n.push(t), (t.x[1] || t.y[1]) && (a.hasRatio = !0), !0)
                    );
                  })
                ? ((a.shape = e.shape), (a.points = n))
                : ((a.shape = 'rect'),
                  (a.radius = pe(e.radius) && 0 <= e.radius ? e.radius : 0)),
            ('rect' !== a.shape && 'circle' !== a.shape) ||
              ((a.x = O.pointAnchor.parsePercent(e.x, !0) || [-0.05, !0]),
              (a.y = O.pointAnchor.parsePercent(e.y, !0) || [-0.05, !0]),
              (a.width = O.pointAnchor.parsePercent(e.width) || [1.1, !0]),
              (a.height = O.pointAnchor.parsePercent(e.height) || [1.1, !0]),
              (a.x[1] || a.y[1] || a.width[1] || a.height[1]) &&
                (a.hasRatio = !0)),
            (t = a.element.ownerDocument),
            (a.svg = e = t.createElementNS(ae, 'svg')),
            (e.className.baseVal = C + '-areaAnchor'),
            e.viewBox.baseVal || e.setAttribute('viewBox', '0 0 0 0'),
            (a.path = e.appendChild(t.createElementNS(ae, 'path'))),
            (a.path.style.fill = a.fill || 'none'),
            (a.isShown = !1),
            (e.style.visibility = 'hidden'),
            t.body.appendChild(e),
            Qe((t = t.defaultView)),
            (a.bodyOffset = qe(t)),
            (a.updateColor = function () {
              var e = a.curStats,
                t = a.aplStats,
                n = a.boundTargets.length
                  ? a.boundTargets[0].props.curStats
                  : null;
              (e.color = n = a.color || (n ? n.line_color : ue.lineColor)),
                Xe(a, t, 'color', n) && (a.path.style.stroke = n);
            }),
            (a.updateShow = function () {
              Je(
                a,
                a.boundTargets.some(function (e) {
        ...
        getStrokeWidth: function (e, t) {
          return (
            O.areaAnchor.update(e) &&
              ...
              ze(function () {
                e.boundTargets.forEach(function (e) {
                  e.props !== t && $e(e.props, { position: !0 });
                });
              }),
        ...
        update: function (t) {
          ...
          if (
            ((v.strokeWidth = Xe(
              ...
              S,
              'strokeWidth',
              null != t.size ? t.size : _ ? _.line_strokeWidth : ue.lineSize,
            )),
            (n = Ie(t.element)),
            (v.elementWidth = Xe(t, S, 'elementWidth', n.width)),
            (v.elementHeight = Xe(t, S, 'elementHeight', n.height)),
            (v.elementLeft = Xe(t, S, 'elementLeft', n.left)),
            (v.elementTop = Xe(t, S, 'elementTop', n.top)),
            v.strokeWidth ||
              (t.hasRatio && (v.elementWidth || v.elementHeight)))
          ) {
            switch (t.shape) {
              case 'rect':
                ((c = {
                  ...
                  (p = S.strokeWidth / 2),
                  (s = (r = Math.min(c.width, c.height))
                    ? (r / 2) * Math.SQRT2 + p
                    : 0),
                  (h = (r = t.radius ? (t.radius <= s ? t.radius : s) : 0)
                    ? ((s = (r - p) / Math.SQRT2),
                      (h = [
                        { x: c.left - (u = r - s), y: c.top + s },
                        { x: c.left + s, y: c.top - u },
                        { x: c.right - s, y: c.top - u },
                        { x: c.right + u, y: c.top + s },
                        { x: c.right + u, y: c.bottom - s },
                        { x: c.right - s, y: c.bottom + u },
                        { x: c.left + s, y: c.bottom + u },
                        { x: c.left - u, y: c.bottom - s },
                      ]),
                      (S.pathListRel = [
                        [
                          h[0],
                          { x: h[0].x, y: h[0].y - (p = r * te) },
                          { x: h[1].x - p, y: h[1].y },
                          h[1],
                        ],
                      ]),
                      h[1].x !== h[2].x && S.pathListRel.push([h[1], h[2]]),
                      S.pathListRel.push([
                        h[2],
                        { x: h[2].x + p, y: h[2].y },
                        { x: h[3].x, y: h[3].y - p },
                      ...
                      h[3].y !== h[4].y && S.pathListRel.push([h[3], h[4]]),
                      S.pathListRel.push([
                        h[4],
                        { x: h[4].x, y: h[4].y + p },
                        { x: h[5].x + p, y: h[5].y },
                      ...
                      h[5].x !== h[6].x && S.pathListRel.push([h[5], h[6]]),
                      S.pathListRel.push([
                        h[6],
                        { x: h[6].x - p, y: h[6].y },
                        { x: h[7].x, y: h[7].y + p },
                      ...
                      h[7].y !== h[0].y && S.pathListRel.push([h[7], h[0]]),
                      S.pathListRel.push([]),
                      (u = r - s + S.strokeWidth / 2),
                      [
                        { x: c.left - u, y: c.top - u },
                        { x: c.right + u, y: c.bottom + u },
                      ])
                    : ((u = S.strokeWidth / 2),
                      (h = [
                        { x: c.left - u, y: c.top - u },
                ...
                (l = {
                  ...
                  (S.pathListRel = [
                    [
                      ...
                      { x: e[0].x, y: e[0].y - (p = h * te) },
                      { x: e[1].x - (r = c * te), y: e[1].y },
                      e[1],
                    ],
                    [
                      e[1],
                  ...
                  (s = c - s + S.strokeWidth / 2),
                  (u = h - u + S.strokeWidth / 2),
                  (e = [
                ...
                t.points.forEach(function (e) {
                  ...
                  i
                    ? (t < i.left && (i.left = t),
                      t > i.right && (i.right = t),
                      e < i.top && (i.top = e),
                      e > i.bottom && (i.bottom = e))
                    : (i = { left: t, right: t, top: e, bottom: e }),
                    o
                      ? S.pathListRel.push([o, { x: t, y: e }])
                      : (S.pathListRel = []),
                    (o = { x: t, y: e });
                }),
                  S.pathListRel.push([]),
          ...
          return (
            ...
            Xe(t, g, 'strokeWidth', (a = S.strokeWidth)) &&
              (t.path.style.strokeWidth = a + 'px'),
            Fe((a = S.pathData), g.pathData) &&
              (t.path.setPathData(a), (g.pathData = a), (v.pathData = !0)),
            t.dash &&
              ((!v.pathData && (!v.strokeWidth || (t.dashLen && t.dashGap))) ||
                ((S.dashLen = t.dashLen || 2 * S.strokeWidth),
                (S.dashGap = t.dashGap || S.strokeWidth)),
              (v.dash = Xe(t, g, 'dashLen', S.dashLen) || v.dash),
              (v.dash = Xe(t, g, 'dashGap', S.dashGap) || v.dash),
              v.dash &&
                (t.path.style.strokeDasharray = g.dashLen + ',' + g.dashGap)),
            (d = S.viewBoxBBox),
            (f = g.viewBoxBBox),
            (y = t.svg.viewBox.baseVal),
            (m = t.svg.style),
            (d.x = S.bBoxRel.left + n.left),
            (d.y = S.bBoxRel.top + n.top),
            (d.width = S.bBoxRel.width),
            (d.height = S.bBoxRel.height),
            ['x', 'y', 'width', 'height'].forEach(function (e) {
              (a = d[e]) !== f[e] &&
                ((y[e] = f[e] = a),
                (m[Q[e]] =
                  a + ('x' === e || 'y' === e ? t.bodyOffset[e] : 0) + 'px'));
            }),
      ...
      mouseHoverAnchor: {
        ...
        init: function (a, i) {
          var n,
            ...
            c = {};
          if (
            ((a.element = O.pointAnchor.checkElement(i.element)),
            (s = a.element),
            !(
              (u = s.ownerDocument) &&
              (h = u.defaultView) &&
              h.HTMLElement &&
              s instanceof h.HTMLElement
            ))
          )
            throw new Error('`element` must be HTML element');
          return (
            (p.style.backgroundSize =
              p.backgroundSize.width + 'px ' + p.backgroundSize.height + 'px'),
            ...
            'inline' ===
            (n = a.element.ownerDocument.defaultView.getComputedStyle(
              a.element,
              '',
            )).display
              ? (a.style.display = 'inline-block')
              : 'none' === n.display && (a.style.display = 'block'),
            O.mouseHoverAnchor.dirKeys.forEach(function (e) {
              var t = e[0],
                e = 'padding' + e[1];
              parseFloat(n[e]) < p.padding[t] &&
                (a.style[e] = p.padding[t] + 'px');
            }),
            a.style.display &&
              ((e = a.element.style.display),
              (a.element.style.display = a.style.display)),
            O.mouseHoverAnchor.dirKeys.forEach(function (e) {
              e = 'padding' + e[1];
              a.style[e] &&
                ((c[e] = a.element.style[e]),
                (a.element.style[e] = a.style[e]));
            }),
            (s = a.element.getBoundingClientRect()).height < p.minHeight &&
              (ie
                ? ((h = p.minHeight),
                  'content-box' === n.boxSizing
                    ...
                    : 'padding-box' === n.boxSizing &&
                      (h -=
                        parseFloat(n.borderTopWidth) +
                        parseFloat(n.borderBottomWidth)),
                  (a.style.height = h + 'px'))
                : (a.style.height =
                    parseFloat(n.height) + (p.minHeight - s.height) + 'px')),
            (a.style.backgroundPosition = re
              ? s.width -
                p.backgroundSize.width -
                p.backgroundPosition.right +
                'px ' +
                p.backgroundPosition.top +
                'px'
              : 'right ' +
                p.backgroundPosition.right +
                'px top ' +
                p.backgroundPosition.top +
                'px'),
            a.style.display && (a.element.style.display = e),
            O.mouseHoverAnchor.dirKeys.forEach(function (e) {
              e = 'padding' + e[1];
            ...
            ['style', 'hoverStyle'].forEach(function (e) {
              ...
              he(n) &&
                Object.keys(n).forEach(function (e) {
                  'string' == typeof n[e] || pe(n[e])
                    ? (t[e] = n[e])
                    : null == n[e] && delete t[e];
                });
            }),
            'function' == typeof i.onSwitch && (r = i.onSwitch),
            i.showEffectName &&
              w[i.showEffectName] &&
              (a.showEffectName = o = i.showEffectName),
            (l = i.animOptions),
        ...
        bind: function (e, t) {
          ...
          return (
            ...
            e.enabled ||
              ((e.styleSave = O.mouseHoverAnchor.getStyles(
                e.elmStyle,
                Object.keys(e.style),
              )),
              O.mouseHoverAnchor.setStyles(e.elmStyle, e.style),
        ...
        unbind: function (e, t) {
          e.enabled &&
            ...
            (e.removeEventListener(),
            O.mouseHoverAnchor.setStyles(e.elmStyle, e.styleSave),
            (e.enabled = !1)),
            O.mouseHoverAnchor.llShow(t.props, !0, e.showEffectName);
        },
        removeOption: function (e, t) {
          O.pointAnchor.removeOption(e, t);
        },
        ...
        llShow: function (e, t, n) {
          w[n || e.curStats.show_effect].stop(e, !0, t),
      ...
      captionLabel: {
        ...
        init: function (l, t) {
          return (
            'string' == typeof t.text && (l.text = t.text.trim()),
            !!l.text &&
              ('string' == typeof t.color && (l.color = t.color.trim()),
              (l.outlineColor =
              ...
              Array.isArray(t.offset) &&
                pe(t.offset[0]) &&
                pe(t.offset[1]) &&
                (l.offset = { x: t.offset[0], y: t.offset[1] }),
              pe(t.lineOffset) && (l.lineOffset = t.lineOffset),
              O.captionLabel.textStyleProps.forEach(function (e) {
                null != t[e] && (l[e] = t[e]);
              }),
              ...
              (l.updateSocketXY = function (e) {
                ...
                null != o.x &&
                  (l.offset
                    ? ((n.x = o.x + l.offset.x), (n.y = o.y + l.offset.y))
                    : ((t = l.height / 2),
                      (e = Math.max(
                        i.attach_plugSideLenSE[l.socketIndex] || 0,
                        i.line_strokeWidth / 2,
                      )),
                      (i = i.position_socketXYSE[l.socketIndex ? 0 : 1]),
                      o.socketId === A || o.socketId === k
                        ? ((n.x =
                            o.socketId === A ? o.x - t - l.width : o.x + t),
                          (n.y =
                            i.y < o.y ? o.y + e + t : o.y - e - t - l.height))
                        : ((n.x =
                            i.x < o.x ? o.x + e + t : o.x - e - t - l.width),
                          (n.y =
                            o.socketId === b ? o.y - t - l.height : o.y + t))),
                  Xe(l, a, 'x', (t = n.x)) &&
                    (l.elmPosition.x.baseVal.getItem(0).value = t),
                  Xe(l, a, 'y', (t = n.y)) &&
                    (l.elmPosition.y.baseVal.getItem(0).value = t + l.height));
              }),
              (l.updatePath = function (e) {
                ...
                e &&
                  ((e = O.captionLabel.getMidPoint(e, l.lineOffset)),
                  (t.x = e.x - l.width / 2),
                  (t.y = e.y - l.height / 2),
                  Xe(l, n, 'x', (e = t.x)) &&
                    (l.elmPosition.x.baseVal.getItem(0).value = e),
                  Xe(l, n, 'y', (e = t.y)) &&
                    (l.elmPosition.y.baseVal.getItem(0).value = e + l.height));
              }),
              (l.updateShow = function (e) {
                O.captionLabel.updateShow(l, e);
              }),
              re &&
                (l.adjustEdge = function (e, t) {
                  var n = l.curStats;
                  null != n.x &&
                    O.captionLabel.adjustEdge(
                      t,
                      { x: n.x, y: n.y, width: l.width, height: l.height },
                      l.strokeWidth / 2,
                    );
                }),
              !0)
        ...
        updateColor: function (e, t) {
          var n = e.curStats,
            a = e.aplStats,
            t = t.curStats;
          (n.color = t = e.color || t.line_color),
            Xe(e, a, 'color', t) && (e.styleFill.fill = t);
        },
        updateShow: function (e, t) {
          t = !0 === t.isShown;
          t !== e.isShown &&
            ((e.styleShow.visibility = t ? '' : 'hidden'), (e.isShown = t));
        },
        ...
        newText: function (e, t, n, a, i) {
          ...
          return (
            ...
            i && !h
              ? ((o = t.createElementNS(ae, 'defs')),
                (r.id = a),
                o.appendChild(r),
                ((l = (e = t.createElementNS(ae, 'g')).appendChild(
                  t.createElementNS(ae, 'use'),
                )).href.baseVal = '#' + a),
                ((t = e.appendChild(
                  t.createElementNS(ae, 'use'),
                )).href.baseVal = '#' + a),
                ((l = l.style).strokeLinejoin = 'round'),
                {
                  elmPosition: r,
                  styleText: r.style,
                  styleFill: t.style,
              ...
              : ((l = r.style),
                i && ((l.strokeLinejoin = 'round'), (l.paintOrder = 'stroke')),
                {
                  elmPosition: r,
                  styleText: l,
                  styleFill: l,
        ...
        getMidPoint: function (e, t) {
          ...
          if (r <= 0)
            return 2 === (n = e[0]).length
              ? Ve(n[0], n[1], 0)
              : Ne(n[0], n[1], n[2], n[3], 0);
          if (i <= r)
            return 2 === (n = e[e.length - 1]).length
              ? Ve(n[0], n[1], 1)
              : Ne(n[0], n[1], n[2], n[3], 1);
          for (a = []; r > o[++l]; ) a.push(e[l]), (r -= o[l]);
          return 2 === (n = e[l]).length
            ? Ve(n[0], n[1], r / o[l])
            : Ne(n[0], n[1], n[2], n[3], We(n[0], n[1], n[2], n[3], r));
        },
        initSvg: function (t, n) {
          var e,
            a,
            i = O.captionLabel.newText(
              t.text,
              n.baseWindow.document,
              n.svg,
              C + '-captionLabel-' + t._id,
              t.outlineColor,
            );
          ['elmPosition', 'styleFill', 'styleShow', 'elmsAppend'].forEach(
            ...
            t.outlineColor &&
              ((a = e.height / 9),
              (i.styleStroke.strokeWidth =
                (a = 10 < a ? 10 : a < 2 ? 2 : a) + 'px'),
              (i.styleStroke.stroke = t.outlineColor)),
            (t.strokeWidth = a || 0),
            Ye(t.aplStats, O.captionLabel.stats),
            t.updateColor(n),
        ...
        bind: function (e, t) {
          var n = t.props;
          return (
            e.color || Ge(n, 'cur_line_color', e.updateColor),
            (e.refSocketXY =
              'startLabel' === t.optionName || 'endLabel' === t.optionName)
              ? ((e.socketIndex = 'startLabel' === t.optionName ? 0 : 1),
                Ge(n, 'apl_position', e.updateSocketXY),
                e.offset ||
                  (Ge(n, 'cur_attach_plugSideLenSE', e.updateSocketXY),
                  Ge(n, 'cur_line_strokeWidth', e.updateSocketXY)))
              : Ge(n, 'apl_path', e.updatePath),
            Ge(n, 'svgShow', e.updateShow),
            re && Ge(n, 'new_edge4viewBox', e.adjustEdge),
            O.captionLabel.initSvg(e, n),
            !0
          );
        },
        unbind: function (e, t) {
          ...
          e.elmsAppend &&
            ...
            Ye(e.curStats, O.captionLabel.stats),
            Ye(e.aplStats, O.captionLabel.stats),
      ...
      pathLabel: {
          ...
          return (
            ...
            !!l.text &&
              ...
              (l.updatePath = function (e) {
                ...
                i &&
                  ((t.pathData = a =
                    O.pathLabel.getOffsetPathData(
                      i,
                      a.line_strokeWidth / 2 + l.strokeWidth / 2 + l.height / 4,
                      1.25 * l.height,
                    )),
                  Fe(a, n.pathData) &&
                    (l.elmPath.setPathData(a),
                    (n.pathData = a),
                    (l.bBox = l.elmPosition.getBBox()),
                    l.updateStartOffset(e)));
              }),
              (l.updateStartOffset = function (e) {
                var i,
                  ...
                  o = e.curStats;
                n.pathData &&
                  ((2 === l.semIndex && !l.lineOffset) ||
                    ((t = n.pathData.reduce(function (e, t) {
                      var n,
                        a = t.values;
                      switch (t.type) {
                        case 'M':
                    ...
                    (e = 0 === l.semIndex ? 0 : 1 === l.semIndex ? t : t / 2),
                    2 !== l.semIndex &&
                      ((o =
                        Math.max(
                          o.attach_plugBackLenSE[l.semIndex] || 0,
                          o.line_strokeWidth / 2,
                        ) +
                        l.strokeWidth / 2 +
                        l.height / 4),
                      (e =
                        (e += 0 === l.semIndex ? o : -o) < 0
                          ? 0
                          : t < e
                            ? t
                            : e)),
                    l.lineOffset &&
                      (e = (e += l.lineOffset) < 0 ? 0 : t < e ? t : e),
                    (n.startOffset = e),
                    Xe(l, a, 'startOffset', e) &&
                      (l.elmOffset.startOffset.baseVal.value = e)));
              }),
              (l.updateShow = function (e) {
                O.captionLabel.updateShow(l, e);
              }),
              re &&
                (l.adjustEdge = function (e, t) {
                  l.bBox &&
                    O.captionLabel.adjustEdge(t, l.bBox, l.strokeWidth / 2);
                }),
              !0)
          );
        },
        getOffsetPathData: function (e, c, n) {
          var d,
            a,
            f = [];
          function y(e, t) {
            ...
            e.forEach(function (e) {
              ...
              2 === e.length
                ? ((s = e[0]),
                  (u = e[1]),
                  (h = c),
                  (p = Math.atan2(s.y - u.y, u.x - s.x) + 0.5 * Math.PI),
                  (t = [
                    { x: s.x + Math.cos(p) * h, y: s.y + Math.sin(p) * h * -1 },
                    { x: u.x + Math.cos(p) * h, y: u.y + Math.sin(p) * h * -1 },
                  ]),
                  d
                    ? ((a = d.points),
                      0 <=
                        ...
                        : ((o = Pe(a[0], a[1], c)),
                          ...
                          (n = (h =
                            0 <= s && s <= 1 && 0 <= u && u <= 1
                              ? { x: l.x + u * p, y: l.y + u * h }
                              : null)
                            ? { type: 'line', points: [(a[1] = h), t[1]] }
                            : ((a[1] = y(i, o) ? i : o),
                              { type: 'line', points: [i, t[1]] })),
                          (d.len = Ae(a[0], a[1]))))
                    : (n = { type: 'line', points: t }),
                  (n.len = Ae(n.points[0], n.points[1])),
                  f.push((d = n)))
                : (f.push({
                    type: 'cubic',
            ...
            f.forEach(function (e) {
              ...
              d =
                'line' === e.type
                  ? (e.inside &&
                      (d.len > c
                        ? (((t = d.points)[1] = Pe(t[0], t[1], -c)),
                          (d.len = Ae(t[0], t[1])))
                        : ((d.points = null), (d.len = 0)),
                      e.len > c + n
                        ? (((t = e.points)[0] = Pe(t[1], t[0], -(c + n))),
                          (e.len = Ae(t[0], t[1])))
        ...
        newText: function (e, t, n, a) {
          ...
          return (
            (u.id = i = n + '-path'),
            ((l = (o = t.createElementNS(ae, 'text')).appendChild(
              t.createElementNS(ae, 'textPath'),
            )).href.baseVal = '#' + i),
            l.startOffset.baseVal.newValueSpecifiedUnits(
              SVGLength.SVG_LENGTHTYPE_PX,
              0,
            ),
            (l.textContent = e),
            'boolean' != typeof h && (h = 'paintOrder' in o.style),
            a && !h
              ? ((o.id = e = n + '-text'),
                s.appendChild(o),
                ((r = (n = t.createElementNS(ae, 'g')).appendChild(
                  t.createElementNS(ae, 'use'),
                )).href.baseVal = '#' + e),
                ((t = n.appendChild(
                  t.createElementNS(ae, 'use'),
                )).href.baseVal = '#' + e),
                ((r = r.style).strokeLinejoin = 'round'),
                {
                  elmPosition: o,
                  elmPath: u,
                  elmOffset: l,
              ...
              : ((r = o.style),
                a && ((r.strokeLinejoin = 'round'), (r.paintOrder = 'stroke')),
                {
                  elmPosition: o,
                  elmPath: u,
                  elmOffset: l,
        ...
        initSvg: function (t, n) {
          ...
          [
            ...
            le &&
              ((i = o.elmOffset.href.baseVal), (o.elmOffset.href.baseVal = '')),
            (e = o.elmPosition.getBBox()),
            le && (o.elmOffset.href.baseVal = i),
            (o.styleText.textAnchor = ['start', 'end', 'middle'][t.semIndex]),
            2 !== t.semIndex ||
              t.lineOffset ||
              o.elmOffset.startOffset.baseVal.newValueSpecifiedUnits(
                SVGLength.SVG_LENGTHTYPE_PERCENTAGE,
                50,
              ),
            (t.height = e.height),
            t.outlineColor &&
              ((a = e.height / 9),
              (o.styleStroke.strokeWidth =
                (a = 10 < a ? 10 : a < 2 ? 2 : a) + 'px'),
              (o.styleStroke.stroke = t.outlineColor)),
            (t.strokeWidth = a || 0),
            Ye(t.aplStats, O.pathLabel.stats),
            t.updateColor(n),
            t.updatePath(n),
        ...
        bind: function (e, t) {
          ...
          return (
            e.color || Ge(n, 'cur_line_color', e.updateColor),
            Ge(n, 'cur_line_strokeWidth', e.updatePath),
            Ge(n, 'apl_path', e.updatePath),
            (e.semIndex =
            ...
            (2 === e.semIndex && !e.lineOffset) ||
              Ge(n, 'cur_attach_plugBackLenSE', e.updateStartOffset),
            Ge(n, 'svgShow', e.updateShow),
            re && Ge(n, 'new_edge4viewBox', e.adjustEdge),
            O.pathLabel.initSvg(e, n),
            !0
          );
        },
        unbind: function (e, t) {
          ...
          e.elmsAppend &&
            ...
            (e.elmPosition =
              ...
              e.elmsAppend =
                null)),
            Ye(e.curStats, O.pathLabel.stats),
            Ye(e.aplStats, O.pathLabel.stats),
            e.color || De(n, 'cur_line_color', e.updateColor),
    ...
    (ot.positionByWindowResize = !0),
    window.addEventListener(
      'resize',
      S.add(function () {
        ot.positionByWindowResize &&
